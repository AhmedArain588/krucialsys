if (!window.KSIcon) {
// Krucial Systems — Inline SVG Icon Library (Lucide-style, MIT)
// Load with: <script src="../shared/icons.js"></script> or <script src="shared/icons.js"></script>
...
const ICON_PATHS = {
  ...
  FlaskConical: `<path d="M14 2v6l3 9H7l3-9V2"/><path d="M6 2h12"/>`,
...
window.KSIcon = function Icon({ name, size = 20, color = 'currentColor', strokeWidth = 1.8, style = {} }) {
...
// Also expose as generic Icon for convenience
window.Icon = window.KSIcon;
